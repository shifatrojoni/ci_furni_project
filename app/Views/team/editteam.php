        ...
        <div class="main">
            ...
            <main class="content">
                <div class="container-fluid p-0">
                    ...
                    <div class="row">
                        <div>
                            <form class="row g-3 needs-validation" action="<?= site_url('/team/upload/'. $id) ?>"  enctype="multipart/form-data" method="post" novalidate>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <textarea class="form-control" id="bsValidation13" placeholder="designation" name="designation" value="" rows="3" required><?php echo $description ?></textarea>
                                    <div class="invalid-feedback">
