        ...
        <div class="main">
            ...
            <main class="content">
                <div class="container-fluid p-0">
                    ...
                    <div class="row">
                        <div>
                            <form class="row g-3 needs-validation" action="<?php echo base_url('/service/store') ?>" enctype="multipart/form-data" method="post" novalidate>

                                <div class="col-md-12">
                                    <label for="bsValidation3" class="form-label">Name</label>
                                    <input type="text" name="name" class="form-control" id="bsValidation3" placeholder="Enter service name" name="name" required>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <textarea class="form-control" id="bsValidation13" placeholder="designation" name="icon" rows="3" required></textarea>
                                    <div class="invalid-feedback">
