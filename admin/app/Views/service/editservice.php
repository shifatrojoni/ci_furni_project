        ...
        <div class="main">
            ...
            <main class="content">
                <div class="container-fluid p-0">
                    ...
                    <div class="row">
                        <div>
                            <form class="row g-3 needs-validation" action="<?= site_url('/service/upload/'. $id) ?>"  enctype="multipart/form-data" method="post" novalidate>

                                <div class="col-md-12">
                                    <label for="bsValidation3" class="form-label">Name</label>
                                    <input type="text" class="form-control" id="bsValidation3" name="name" placeholder="Enter name" value="<?php echo $name ?>"  required>
                                ...
                                <div class="col-md-12">
                                    <label for="bsValidation13" class="form-label">Icon</label>
                                    <textarea class="form-control" id="bsValidation13" placeholder="icon" name="icon" value="" rows="3" required><?php echo $description ?></textarea>
                                    <div class="invalid-feedback">
