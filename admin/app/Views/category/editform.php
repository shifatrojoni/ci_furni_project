        ...
        <div class="main">
            ...
            <main class="content">
                <div class="container-fluid p-0">
                    ...
                    <div class="row">
                        <div>
                            <form class="row g-3 needs-validation" action="<?= site_url('/category/upload/'. $id) ?>"  enctype="multipart/form-data" method="post" novalidate>

                                <div class="col-md-12">
                                    <label for="bsValidation3" class="form-label">Category Name</label>
                                    <input type="text" class="form-control" id="bsValidation3" name="name" placeholder="Enter category name" value="<?php echo $name ?>"  required>
