        ...
        <div class="main">
            ...
            <main class="content">
                <div class="container-fluid p-0">
                    ...
                    <div class="row">
                        <div>
                            <form class="row g-3 needs-validation" action="<?php echo base_url('/product/store') ?>" enctype="multipart/form-data" method="post" novalidate>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <textarea class="form-control" id="bsValidation13" placeholder="description ..." name="sku" rows="3" required></textarea>
                                    <div class="invalid-feedback">
                                        Please enter a valid address.
                                    </div>
                                </div>
