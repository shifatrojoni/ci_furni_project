...
<head>
    ...
    <link rel="shortcut icon" href="<?= site_url('assets/img/icons/icon-48x48.png')?>" />
        ...
        <div class="main">
            ...
            <main class="content">
                <div class="container-fluid p-0">
                    ...
                    <div class="row">
                        <div>
                            <form class="row g-3 needs-validation" action="<?= site_url('/product/upload/'. $id) ?>"  enctype="multipart/form-data" method="post" novalidate>

                                <div class="col-md-12">
                                    <label for="bsValidation3" class="form-label">Product Name</label>
                                    <input type="text" class="form-control" id="bsValidation3" placeholder="Enter product name" value="<?php echo $name ?>" name="name" required>
                                ...
                                <div class="col-md-12">
                                    <label for="bsValidation13" class="form-label">Sku</label>
                                    <textarea class="form-control" id="bsValidation13" placeholder="description ..." name="sku" value="" rows="3" required><?php echo $description ?></textarea>
                                    <div class="invalid-feedback">
                                        Please enter a valid address.
                                    </div>
                                </div>
