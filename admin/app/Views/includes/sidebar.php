<nav id="sidebar" class="sidebar js-sidebar">
	<div class="sidebar-content js-simplebar">
		<a class="sidebar-brand" href="index.html">
			<span class="align-middle">Furniture shop</span>
		</a>
		...
		<ul class="sidebar-nav">
			...
			<li class="sidebar-item">
				<a class="sidebar-link" href="/payment">
					<i class="align-middle" data-feather="square"></i> <span class="align-middle">Payment</span>
				</a>
			</li>
			...
			<li class="sidebar-item">
				<a class="sidebar-link" href="/service">
					<i class="align-middle" data-feather="grid"></i> <span class="align-middle">Service</span>
				</a>
			</li>

			<li class="sidebar-item">
				<a class="sidebar-link" href="/testimonial">
					<i class="align-middle" data-feather="align-left"></i> <span class="align-middle">Testimonial</span>
				</a>
			</li>

			<li class="sidebar-item">
				<a class="sidebar-link" href="/team">
					<i class="align-middle" data-feather="coffee"></i> <span class="align-middle">Our Team</span>
				</a>
			</li>
